...
- [6. How to Run the Simulation](#6-how-to-run-the-simulation)
- [7. Robot Description Details](#7-robot-description-details)
- [8. Topics, Frames & Controllers](#8-topics-frames--controllers)
- [9. Parameters](#9-parameters)
- [10. RViz & Debug Tools](#10-rviz--debug-tools)
- [11. Common Issues & Troubleshooting](#11-common-issues--troubleshooting)
- [12. Roadmap / TODO](#12-roadmap--todo)
